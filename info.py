...
BOT_TOKEN = environ.get('BOT_TOKEN', '694288622-Vk')
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '949657126').split()]
USERNAME = environ.get('USERNAME', "https://t.me/Tonystarkk616") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002134871596'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/Movie_Loverzz')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("FQDN", "https://mlfiletolink-6e3e574cf9c1.herokuapp.com/")
